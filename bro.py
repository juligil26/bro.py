peluches=["rochi","conejito","aguagatico"]
...
while opcion!=5:
    ...
    if opcion==1:
        ...
        #Agregado datos a una lista. 
        peluches.append(nombre)
        print("Peluche  agregado con exito")
    elif opcion==2:
        print("bro estas en la opcion 2")
    elif opcion==3:
        print("bro estas en la opcion 3")
    elif opcion==4:
        print("bro estas en la opcion 4")
    elif opcion==5:
        print("bro chao pues")
    else:
